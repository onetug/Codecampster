...
namespace Codecamp.Migrations
{
    ...
    [Migration("20180821235115_codecampuser-speaker-relationship-3")]
    partial class codecampuserspeakerrelationship3
    {
            ...
            modelBuilder.Entity("Codecamp.Models.Speaker", b =>
                {
                    ...
                    b.HasIndex("CodecampUserId")
                        .IsUnique()
                        .HasFilter("[CodecampUserId] IS NOT NULL");
            ...
            modelBuilder.Entity("Codecamp.Models.Speaker", b =>
                {
                    b.HasOne("Codecamp.Models.CodecampUser", "CodecampUser")
                        .WithOne("Speaker")
                        .HasForeignKey("Codecamp.Models.Speaker", "CodecampUserId");
                });
